...
### 2026-06-23
- **feat(visits):** الزيارات الإشرافية (§4.15) — بطاقات إحصائية + جدولة زيارة (حلقة/مشرف/موعد) + تنفيذها برفع النتائج (تقييم/قوة/تحسين/توصيات/ملاحظات) + تصفية بالحالة + حذف (المدير). المشرف يدير زياراته (RLS)
